---
title: 01-类加载机制
description: 学习类加载机制的目的是为了解当利用反序列化的时候，明确怎么触发字节码，类是否可以加载
date: 2026-04-25
tag:
  - Java
  - Security
...
上述代码在准备阶段：
1. `var1` 不会分配内存
2. `var2` 会被分配内存初始值为`null`
3. `var3`是(`static final`)常量会被初始化为`test3`。
...
# 参考文章
[一文彻底搞懂 Java 类加载机制](https://javabetter.cn/jvm/class-load.html)
[类加载过程详解](https://javaguide.cn/java/jvm/class-loading-process.html#%E5%8A%A0%E8%BD%BD)
[Java 类加载篇（一）ClassLoader 类加载机制总结](https://qidawu.github.io/posts/java-classloader/#%E7%B1%BB%E5%8A%A0%E8%BD%BD%E5%99%A8%E6%BA%90%E7%A0%81%E8%A7%A3%E6%9E%90)