...
1. CC6 : `HashMap#hashcode -> TiedMapEntry#hashcode -> LazyMap#get`
2. CC5 ：`BadAttributeValueExpException#toString -> TiedMapEntry#toString -> LazyMap#get`
